...
{
    var ajaxUrl=base_url+'/Evaluadores/llenarInstitucion';
...
{
    if(document.querySelector("#formRegistroEvaluador"))
    {
        let formRegistroEvaluador=document.querySelector("#formRegistroEvaluador");
        formRegistroEvaluador.onsubmit=function(e)
        {
            e.preventDefault();
            ...
            let strExt=document.querySelector('#txtExt').value;
            ...
            var request=(window.XMLHttpRequest)?new XMLHttpRequest():new ActiveXObject('Microsoft.XMLHTTP');
            var ajaxUrl=base_url+'/Evaluadores/register';
            var formData=new FormData(formRegistroEvaluador);
