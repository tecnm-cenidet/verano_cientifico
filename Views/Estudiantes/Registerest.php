    ...
    <main class="content">
        <div class="container-fluid">
            ...
            <div class="text-center mt-4">
                <h1 class="h2">Registro de Estudiantes</h1>
                <p>Para registrarte en algunas de las temáticas del verano debes primero tener un perfil.</p>
                <p>Ingresa la siguiente información para crearlo.</p>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form id="formRegistroEstudiantes" name="formRegistroEstudiantes">
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <label for="validationCustomUsername" class="form-label">*Clave Única de registro de población (CURP):</label>
                                        <input type="text" id="txtCurp" name="txtCurp" class="form-control" onkeyup="javascript:this.value=this.value.toUpperCase();" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="validationCustomUsername" class="form-label">*Número de Teléfono móvil:</label>
                                        <input type="text" id="txtCel" name="txtCel" class="form-control" onkeyup="javascript:this.value=this.value.toUpperCase();" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="validationCustomUsername" class="form-label">*Número de Telefono fijo:</label>
