...
<body class="theme-blue">
    ...
    <main class="main h-100 w-100 flipped">
                ...
                <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="text-center mt-4">
                            <h1 class="h2">Cambiar Password</h1>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <form name="formCambiarPass" id="formCambiarPass">
                                        <input type="hidden" id="txtUserId" name="txtUserId" value="<?= $data['user_id'] ?>" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-lg" type="password" id="txtNuevoPassword" name="txtNuevoPassword" placeholder="Teclea el nuevo password" required />
                                        </div>
                                        <div class="form-group">
                                            <label>Confirmar Password</label>
                                            <input class="form-control form-control-lg" type="password" id="txtConfirmarPassword" name="txtConfirmarPassword" placeholder="Confirmar password" required />
                                        </div>
                                        <div class="text-center mt-3">
                                            <button type="submit" class="btn btn-lg btn-primary">Cambiar Password</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
