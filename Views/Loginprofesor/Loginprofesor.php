                            ...
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <div class="text-center">
                                        <img src="<?= media() ?>/img/logos/tecnmandcenidet.png" alt="logo" class="img-fluid" />
                                    </div>
                                    <form name="formLoginProfesor" id="formLoginProfesor">
                                        <div class="form-group">
                                            <label>ID TeCNM:</label>
                                            <input id="txtIdTec" class="form-control form-control-lg" type="text" name="txtIdTec" placeholder="Teclea tu ID (IT######)" required maxlength="8" />
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <input id="txtPassword" class="form-control form-control-lg" type="password" name="txtPassword" placeholder="Teclea tu password" required />
                                        </div>
