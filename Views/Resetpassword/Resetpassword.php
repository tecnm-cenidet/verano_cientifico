                ...
                <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <p class="lead">
                                Teclea tu Email para resetear tu password
                            </p>
                        </div>
                                ...
                                <div class="m-sm-4">
                                    <form id="formResetPass" name="formResetPass">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input id="txtEmail" class="form-control form-control-lg" type="email" name="txtEmail" placeholder="Teclear tu email" required />
                                            <medium>
                                                <a href="<?= base_url() ?>/login">Inisiar Sesión</a>
                                            </medium>
                                        </div>
                                        <div class="text-center mt-3">
                                            <button type="submit" class="btn btn-lg btn-primary">Resetear password</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
